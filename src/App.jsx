...
function App() {
  ...
  return (
    <div className=' bg-gradient-to-b from-[#FAFAFA] to-[#FCFCFC] h-fit w-[98.9vw]'>
      <NavBar/>
      <p className="text-[55px] font-[700] font-['poppins'] text-[#00203F] w-[1058px] mx-auto p- mt-[107px]" >Medicines, Cars, Dining, Electronics 
      ...
      <div className='w-[346px] h-[360px] bg-[#00E0FF] bg-opacity-[37%] rounded-xl'>
        ...
        <Button className="bg-[#00588A] h-[31px] w-[123px] mt-[20px] rounded-full"> Visit page</Button>
      </div>
      ...
      <div className='w-[346px] h-[360px] bg-[#FFC700] bg-opacity-[37%] rounded-xl'>
        ...
        <Button className="bg-[#665E40] h-[31px] w-[123px] mt-[15px] rounded-full"> Visit page</Button>
      </div>
      ...
      <div className='w-[346px] h-[360px] bg-[#FF7A00] bg-opacity-[47%] rounded-xl'>
        ...
        <Button className="bg-[#664D36] h-[31px] w-[123px] mt-[20px] rounded-full"> Visit page</Button>
      </div>
      
      <div className='w-[346px] h-[360px] bg-[#42FF00] bg-opacity-[37%] rounded-xl'>
        <Image src={medicine} height={193}  className='mx-auto'/>
        ...
        <Button className="bg-[#4A6640] h-[31px] w-[123px] mt-[20px] rounded-full"> Visit page</Button>
      </div>
      </div>
    </div>
  )
